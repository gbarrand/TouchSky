//-----------------------------------------------------------
// class SimpleMatrixOperation<T> , LinFitter<T> ...
//  Operations on matrices using basic algorithms 
// SOPHYA class library - (C)  UPS+LAL IN2P3/CNRS  , CEA-Irfu 
//                E. Aubourg, R. Ansari, C.Magneville   2000
//-----------------------------------------------------------
...
template class TMatrixRC< std::complex<r_4> >;
template class TMatrixRC< std::complex<r_8> >;
...
template class SimpleMatrixOperation< std::complex<r_4> >;
template class SimpleMatrixOperation< std::complex<r_8> >;
template class LinFitter<r_4>;
template class LinFitter<r_8>;
template class LinFitter< std::complex<r_4> >;
template class LinFitter< std::complex<r_8> >;
#ifdef SO_LDBLE128
template class TMatrixRC<r_16>;
template class TMatrixRC< std::complex<r_16> >;
template class SimpleMatrixOperation<r_16>;
template class SimpleMatrixOperation< std::complex<r_16> >;
template class LinFitter<r_16>;
template class LinFitter< std::complex<r_16> >;
#endif
}
#endif
