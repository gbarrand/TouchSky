...
template class FIO_LocalMap<int_8>;
template class FIO_LocalMap<r_4>;
template class FIO_LocalMap<r_8>;
template class FIO_LocalMap< std::complex<r_4> >;
template class FIO_LocalMap< std::complex<r_8> >;
#ifdef SO_LDBLE128
template class FIO_LocalMap<r_16>;
template class FIO_LocalMap< std::complex<r_16> >;
#endif
