...
template <class T>
size_t DataTypeInfo<T>::getTypeSize()
{
  if (typeid(T) == typeid(uint_1)) return(1);
  else if (typeid(T) == typeid(int_1)) return(1);
  else if (typeid(T) == typeid(uint_2)) return(2);
  else if (typeid(T) == typeid(int_2)) return(2);
  else if (typeid(T) == typeid(int_4)) return(4);
  else if (typeid(T) == typeid(int_8)) return(8);
  else if (typeid(T) == typeid(uint_4)) return(4);
  else if (typeid(T) == typeid(uint_8)) return(8);
  else if (typeid(T) == typeid(r_4)) return(4);
  else if (typeid(T) == typeid(r_8)) return(8);
  else if (typeid(T) == typeid(complex<r_4>)) return(8);
  else if (typeid(T) == typeid(complex<r_8>)) return(16);
#ifdef SO_LDBLE128
  else if (typeid(T) == typeid(r_16)) return(16);
  else if (typeid(T) == typeid(complex<r_16>)) return(32);
#endif
  else return("???unknowntype???");
}
template <class T>
...
/*!
   ...
   \brief class returning type name and size for usual numerical types (int_2,int_4,r_4,r_8 ...)
*/  
...
//!  return the base type size (int_8 -> 4 , r_4 -> 4 , complex<r_8> -> 16 ...) sizeof(T)
template <class T>
size_t DataTypeInfo<T>::getTypeSize() { return sizeof(T); }
