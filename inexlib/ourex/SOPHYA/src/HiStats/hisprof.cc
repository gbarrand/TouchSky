//-----------------------------------------------------------
// Classe HProf (Profile Histogram)   
...
/********* Methode *********/
/*!
  Pour changer les limites de calcul des moyennes et sigma
*/
void HProf::SetYLim(double ymin, double ymax)
{
mYMin = ymin;
mYMax = ymax;
}
...
/********* Methode *********/
/*!
  Retourne la somme des poids du bin i dans le vecteur v
*/
void HProf::GetSumW(TVector<r_8>& v)
{
if(mBins<=0) return;
v.Realloc(mBins);
for(int_4 i=0;i<mBins;i++) v(i) = mSumW[i];
}
