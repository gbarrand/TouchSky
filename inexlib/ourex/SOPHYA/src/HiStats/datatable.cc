...
void DataTable::Share(DataTable const & a)
{
  ...
  for (size_t kk=0; kk<mNames.size(); kk++) {
    ...
    case FMLStr64Field :
      ...
      break;
    case FlagVec16Field :
      mB16Cols[sk].Share(a.mB16Cols[ska]); 
      break;
    case FlagVec64Field :
      mB64Cols[sk].Share(a.mB64Cols[ska]); 
      break;
    default:
...
void DataTable::Clone(DataTable const & a)
{
  ...
  for (size_t kk=0; kk<mNames.size(); kk++) {
    ...
    case DateTimeField :
      ...
      break;
    case CharacterField :
      mCCols[sk].Clone(a.mCCols[ska], true); 
      break;
    case FMLStr16Field :
    ...
    case FMLStr64Field :
      ...
      break;
    case FlagVec16Field :
      mB16Cols[sk].Clone(a.mB16Cols[ska], true); 
      break;
    case FlagVec64Field :
      mB64Cols[sk].Clone(a.mB64Cols[ska], true); 
      break;
    default:
...
size_t DataTable::AddColumn(FieldType ft, string const & cnom, size_t vsz, bool fgfcnet)
{
  ...
  */
  ...
  case CharacterField :
    ser = mCCols.size();
    mCCols.push_back(SegDataBlock<char>(segsz, 0, vsz));
  ...
  case FlagVec16Field :
    ser = mB16Cols.size();
    mB16Cols.push_back(SegDataBlock< FlagVector16 >(segsz,0,vsz));
  ...
  case FlagVec64Field :
    ser = mB64Cols.size();
    mB64Cols.push_back(SegDataBlock< FlagVector64 >(segsz,0,vsz));
