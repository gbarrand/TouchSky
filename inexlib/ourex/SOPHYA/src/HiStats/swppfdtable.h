...
protected:
  SwPPFDataTable(PInPersist* isp, size_t segsz); 
  ...
  std::vector< SwPPFSegDataBlock<char> > mCCols; 
  PPFDataSwapper<char> mCSwapper;
  ...
  std::vector< SwPPFSegDataBlock< FlagVector16 > > mB16Cols;    
  PPFDataSwapper< FlagVector16 > mB16Swapper;
  std::vector< SwPPFSegDataBlock< FlagVector64 > > mB64Cols;    
  PPFDataSwapper< FlagVector64 > mB64Swapper;
