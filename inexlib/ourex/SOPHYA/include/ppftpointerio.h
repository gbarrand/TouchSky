...
DECL_TEMP_SPEC  /* equivalent a template <> , pour SGI-CC en particulier */
class PPF_TPointer_IO< std::complex<r_4> > {
public:
  static void Copy(std::complex<r_4> * dest, std::complex<r_4> const * src, size_t n);
  static void Write(POutPersist & os, std::complex<r_4>  const * arr, size_t n);
  static void Read(PInPersist & is, std::complex<r_4> * arr, size_t n);
  static bool isFixed_IO_RecordSize() { return true; } 
};
DECL_TEMP_SPEC  /* equivalent a template <> , pour SGI-CC en particulier */
class PPF_TPointer_IO< std::complex<r_8> > {
public:
  static void Copy(std::complex<r_8> * dest, std::complex<r_8> const * src, size_t n);
  static void Write(POutPersist & os, std::complex<r_8>  const * arr, size_t n);
  static void Read(PInPersist & is, std::complex<r_8> * arr, size_t n);
  static bool isFixed_IO_RecordSize() { return true; } 
};
DECL_TEMP_SPEC  /* equivalent a template <> , pour SGI-CC en particulier */
...
DECL_TEMP_SPEC  /* equivalent a template <> , pour SGI-CC en particulier */
class PPF_TPointer_IO< std::complex<r_16> > {
public:
  static void Copy(std::complex<r_16> * dest, std::complex<r_16> const * src, size_t n);
  static void Write(POutPersist & os, std::complex<r_16>  const * arr, size_t n);
  static void Read(PInPersist & is, std::complex<r_16> * arr, size_t n);
  static bool isFixed_IO_RecordSize() { return true; } 
};
#endif
