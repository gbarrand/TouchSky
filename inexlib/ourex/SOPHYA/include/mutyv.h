...
public:
  ...
  inline MuTyV() { typ = MTVInteger; iv = 0;  dv = dv_im = 0.;  strv = NULL; }
         MuTyV(MuTyV const & a);
  inline MuTyV(bool b)   { typ = MTVBoolean; iv = (int_8)b;  dv = (r_8)iv; dv_im = 0.;  strv = NULL; }
  inline MuTyV(char c)   { typ = MTVCharacter; iv = (int_8)c;  dv = (r_8)iv; dv_im = 0.;  strv = NULL; }
  ...
  inline MuTyV(std::complex<r_4> const& z) { typ = MTVComplex;
    dv = (r_8)z.real();  dv_im = (r_8)z.imag();  
    iv = (int_8)dv;  strv = NULL; } 
  inline MuTyV(std::complex<r_8> const& z) { typ = MTVComplex; dv = z.real();  dv_im = z.imag();  
    iv = (int_8)dv;  strv = NULL; } 
#ifdef SO_LDBLE128
  inline MuTyV(std::complex<r_16> const& z) { typ = MTVComplex;
    dv = (r_8)z.real();  dv_im = (r_8)z.imag();  
    iv = (int_8)dv;  strv = NULL; }
#endif
         MuTyV(char const* s);  
         MuTyV(std::string const& s); 
         MuTyV(TimeStamp const& ts); 

         ~MuTyV();
 
         MuTyV & operator= (MuTyV const & a);
  inline MuTyV & operator= (bool v)    { typ = MTVBoolean; iv = (int_8)v;  dv = (r_8)iv;  dv_im = 0.; return(*this); }
  inline MuTyV & operator= (char v)    { typ = MTVCharacter; iv = (int_8)v;  dv = (r_8)iv;  dv_im = 0.; return(*this); }
  ...
  inline MuTyV & operator= (std::complex<r_4> const& v) { typ = MTVComplex; dv = (r_8)v.real();  dv_im = (r_8)v.imag();
                                                    iv = (int_8)dv;  return(*this); }
  inline MuTyV & operator= (std::complex<r_8> const& v) { typ = MTVComplex; dv = (r_8)v.real();  dv_im = v.imag();
                                                    iv = (int_8)dv;  return(*this); }
#ifdef SO_LDBLE128
  inline MuTyV & operator= (r_16 v) { typ = MTVFloat; dv = (r_8)v; iv = (int_8)v;  dv_im = 0.;  return(*this); }
  inline MuTyV & operator= (std::complex<r_16> const& v) { typ = MTVComplex; dv = (r_8)v.real();  dv_im = (r_8)v.imag();
                                                    iv = (int_8)dv;  return(*this); }
#endif
  ...
  inline operator bool()   const { return((bool)iv); }
  inline operator char()   const { return((char)iv); }
  ...
  inline operator std::complex<r_4>() const { return(std::complex<r_4>((r_4)dv, (r_4)dv_im)); }
  inline operator std::complex<r_8>() const { return(std::complex<r_8>(dv, dv_im)); }
#ifdef SO_LDBLE128
  inline operator r_16() const  { return((r_16)dv); }
  inline operator std::complex<r_16>() const { return(std::complex<r_16>((r_16)dv, (r_16)dv_im)); }
#endif

  operator std::string() const ; 
  operator TimeStamp() const ; 

  inline bool   Convert(bool& x)   const { x = (bool)iv; return x; }
  inline char   Convert(char& x)   const { x = (char)iv; return x; }
  ...
  inline std::complex<r_4> Convert(std::complex<r_4> & x) const 
  { x = std::complex< r_4 > ((r_4)dv, (r_4)dv_im); return x; }
  inline std::complex<r_8> Convert(std::complex<r_8> & x) const 
  { x = std::complex< r_8 > (dv, dv_im); return x; }
#ifdef SO_LDBLE128
  inline r_16 Convert(r_16& x) const { x = (r_16)dv; return x; }
  inline std::complex<r_16> Convert(std::complex<r_16> & x) const 
  { x = std::complex< r_16 > ((r_16)dv, (r_16)dv_im); return x; }
#endif  
  std::string&  Convert(std::string& x) const ; 
  ...
  inline std::string*  GetStringPointer() const { return (strv); } 
...
inline std::ostream& operator << (std::ostream& s, MuTyV const & mtv)
{  s << (std::string)mtv;   return(s); }
