//-----------------------------------------------------------
// Classes Poly Poly2 :   Polynomes et ajustement 
// SOPHYA class library - (C)  UPS+LAL IN2P3/CNRS  , CEA-Irfu 
// E. Aubourg         (C) DAPNIA/SPP  CEA     1996-1998
//-----------------------------------------------------------


// Des polynomes avec des operations de bases et surtout des fits (Ajustement)
//  Heritage PEIDA / EROS 
...
public:
  ...
  */
  ...
  std::ostream& Print(std::ostream& s, sa_size_t maxprt=-1, 
...
inline std::ostream& operator << (std::ostream& s, const Poly& a)
  { return a.Print(s); }
...
inline std::ostream& operator << (std::ostream& s, const Poly2& a)
  { return a.Print(s); }
