...
public:
  ...
  void SetYLim(double ymin=1., double ymax=-1.);
  void Zero();
  ...
  //! Retourne la somme des poids du bin i
...
inline std::ostream& operator << (std::ostream& s, HProf const & h)
  {  h.Show(s);  return(s);  }
