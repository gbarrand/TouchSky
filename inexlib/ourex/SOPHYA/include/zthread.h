//-----------------------------------------------------------
// Classes ZThread , ZMutex , ZSync , ZThreadExc
//  Interface C++ aux Thread POSIX  -   
// SOPHYA class library - (C)  UPS+LAL IN2P3/CNRS  , CEA-Irfu 
// R. Ansari          (C) UPS+LAL IN2P3/CNRS  2001 
//-----------------------------------------------------------
...
public:
  explicit ZThreadExc(const std::string& m, int id=0) throw() : PException(m,id) {}
