...
public:
  ...
  explicit QNumber(int_8 m, int_8 n=1)
  { 
  ...
  //! copy (equal) operator from an integer 
  inline QNumber& operator = (int n) 
  { num_=n;  den_=1; return(*this); }   
  //! copy (equal) operator from an integer 
  inline QNumber& operator = (long n) 
  { num_=n;  den_=1; return(*this); }   
  //! copy (equal) operator from an integer 
  inline QNumber& operator = (long long n) 
  { num_=n;  den_=1; return(*this); }   
...
inline std::ostream& operator << (std::ostream& s, QNumber const& q)
  {  return q.Print(s);  }
...
inline std::istream& operator >> (std::istream& s, QNumber& q)
{  
