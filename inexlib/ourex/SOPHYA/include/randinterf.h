...
//! Select Exponential generation algorithm 
  ...
  virtual void GenerateSeedVector(int nseed,std::vector<uint_2>& seed,int lp=0);
 ...
 /*! \brief Return a random number following a gaussian distribution with mean=mu, and sigma */ 
  ...
  inline std::complex< r_8 > ComplexGaussian(void)
    {return std::complex< r_8 >(Gaussian(),Gaussian());}
  inline std::complex< r_8 > ComplexGaussian(double sig)
    {return std::complex< r_8 >(sig*Gaussian(),sig*Gaussian());}
