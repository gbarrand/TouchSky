...
class STSRandGen : public AnyDataObj {
 ...
 /*! \brief Return a random number following a gaussian distribution with mean=mu, and sigma */ 
  ...
  inline std::complex< r_8 > ComplexGaussRan(void)
    {return std::complex< r_8 >(NorRand(),NorRand());}
  inline std::complex< r_8 > ComplexGaussRan(double sig)
    {return std::complex< r_8 >(sig*NorRand(),sig*NorRand());}
